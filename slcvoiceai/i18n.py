...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "feed.watcher_started": "-- watching for SLC from now on; no need to restart Windows first",
        "feed.watcher_failed": "-- could not start the watcher: {error}",
    ...
    "pl": {
        ...
        "feed.watcher_started": "-- od teraz pilnuję SLC; nie trzeba najpierw restartować Windowsa",
        "feed.watcher_failed": "-- nie udało się uruchomić obserwatora: {error}",
